...
#continuous variable
summary(lm(losdays2~ageyear,data = data))
summary(lm(losdays2~bmi,data = data))
summary(lm(losdays2~bpsystolic,data = data))
summary(lm(losdays2~o2sat,data = data))
summary(lm(losdays2~temperature,data = data))
summary(lm(losdays2~heartrate,data = data))
summary(lm(losdays2~respirationrate,data = data))
summary(lm(losdays2~bpdiastolic,data = data))
...
summary(lm(log(losdays2)~heartrate,data = data))
summary(lm(log(losdays2)~respirationrate,data = data))
summary(lm(log(losdays2)~bpdiastolic,data = data))


#categorical varialbe
summary(lm(losdays2~as.factor(mews_catg),data=data))
summary(lm(losdays2~as.factor(cindex_catg),data=data))
summary(lm(losdays2~as.factor(evisit_catg),data=data))
summary(lm(losdays2~as.factor(icu_flag),data=data))
summary(lm(losdays2~as.factor(gender),data=data))
summary(lm(losdays2~as.factor(race_catg),data=data))
