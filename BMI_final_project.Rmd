...
data = data %>%
  select(patientid, visitid, loshours, losdays2, date, cindex, evisit, icu_flag, ageyear, gender, race, religion, maritalstatus, facilityname, insurancetype, bpsystolic, o2sat, temperature, heartrate, respirationrate, bpdiastolic, log_day) %>% 
